...
export default function Tabs() {
  ...
  return (
    <div className="flex z-50 w-full  mt-auto max-w-sm   bg-black border-[1px] border-[#31313180] p-2  rounded-3xl  bottom-6 left-1/2 sticky">
          ...
          >
            <img
              className={`w-6 h-6 mb-1 text-gray-500  group-hover:text-blue-600 ${
                location.pathname === tab.path && tab.id != "Earn"
                  ? "invert"
                  : ""
              }`}
              src={tab.img}
